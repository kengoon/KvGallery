...
`KivyMD` provides the following card class for use:

- MDCard_
- MDCardSwipe_

.. Note:: :class:`~MsCard` inherited from
...
class MsCard(
    ...
    all_radius = ListProperty([0])

    radius = all_radius

    border_radius = all_radius
    """
    Card border radius.
...
class MDCardSwipeFrontBox(MsCard):
    pass
